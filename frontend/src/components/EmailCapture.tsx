...
export function EmailCapture({
  ...
  subtext = "Join the list for early access and lifetime founding member pricing.",
}: EmailCaptureProps) {
    ...
    if (variant === 'inline') {
      return (
        <div className="flex items-center gap-2 mt-4">
          ...
          <p className="text-[13px] text-[rgba(245,240,232,0.4)]">You&apos;re on the list — we&apos;ll be in touch before launch.</p>
        </div>
      );
    }
    return (
      <div className="glass-card rounded-2xl p-10 text-center">
        ...
        <p className="text-sm text-[var(--text-muted)]">We&apos;ll reach out before launch with your founding-member access.</p>
      </div>
    );
  }
