...
export default function AmenitiesPage() {
  ...
  if (!isConnected) {
    return <AuthWall title="Amenities" description="Connect your wallet to access this section of SuvrenHOA." />;
  }
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8 page-enter">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-3xl sm:text-4xl font-medium gradient-text sm:"> Amenity Booking</h1>
      ...
      <div className="space-y-4">
        ...
        {activeTab === 'book' ? (
          <div className="glass-card rounded-xl p-5 space-y-4">
            {success && (
              <div className="p-3 rounded-lg bg-[rgba(42,93,79,0.10)] border border-[rgba(42,93,79,0.20)] text-xs text-[#2A5D4F]">
                 Booking confirmed!
              </div>
            )}
