    ...
    <div className="max-w-lg mx-auto px-4 py-10 page-enter">
      ...
      {step === 1 && (
        <div className="glass-card rounded-lg p-7 border-l-2 border-l-amber-500/50 animate-fade-in">
          ...
          <div className="mb-7">
            ...
            <input
              className="w-full bg-gray-800/60 border border-gray-700/60 rounded-md px-4 py-3 text-sm text-gray-200 placeholder-gray-500 focus:outline-none focus:border-amber-500/50"
          ...
          <button
            ...
            className="w-full py-3.5 rounded-md bg-amber-600 hover:bg-amber-500 disabled:opacity-40 disabled:cursor-not-allowed text-white font-semibold text-sm transition-all"
          >
            Continue →
          </button>
          {isCurrent === false && (
      ...
      {step === 2 && (
        <div className="glass-card rounded-lg p-7 animate-fade-in">
          ...
          >
            ...
            {isCurrent === false ? (
              <div>
                ...
                <Link
                  href="/dues"
                  className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-md bg-red-600/20 border border-red-500/30 hover:bg-red-600/30 text-sm font-semibold text-red-300 transition-all"
                >
          ...
          {/* Confirmation */}
          <div className="border border-amber-500/20 rounded-md p-4 mb-7 bg-amber-500/5">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={goNext}
              disabled={!step2Valid}
              className="flex-1 py-3 rounded-md bg-amber-600 hover:bg-amber-500 disabled:opacity-40 disabled:cursor-not-allowed text-white font-semibold text-sm transition-all"
            >
              Confirm →
            </button>
          </div>
      ...
      {step === 3 && (
        <div className="glass-card rounded-lg p-10 text-center animate-fade-in border-l-2 border-l-amber-500/50">
          ...
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-md bg-gray-800/60 border border-gray-700/50 text-gray-300 hover:text-white font-semibold text-sm transition-all"
          >
            ← Return to Dashboard
          </Link>
        </div>
