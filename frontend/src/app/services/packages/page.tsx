        ...
        <div className="flex gap-3 mb-5 flex-wrap">
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="bg-[oklch(0.12_0.005_60)] border border-[oklch(0.20_0.005_60)] rounded-lg px-3 py-1.5 text-sm text-[#D4C4A0] focus:outline-none focus:border-[#B09B71] w-32"
            />
          </div>
              ...
              <div className="flex gap-2 shrink-0">
                ...
                {pkg.status === 'delivered' && (
                  <button
                    ...
                    className="text-xs px-3 py-1.5 rounded-lg bg-[oklch(0.14_0.005_60)] border border-[oklch(0.22_0.005_60)] text-[oklch(0.55_0.01_60)] hover:text-[#D4C4A0] transition-colors"
                  >
                    Mark Held
                  </button>
                )}
          ...
          <div className="bg-[oklch(0.12_0.005_60)] border border-[oklch(0.22_0.005_60)] rounded-xl p-6 max-w-md w-full">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={key}>
                  ...
                  <input
                    ...
                    className="w-full bg-[oklch(0.16_0.005_60)] border border-[oklch(0.24_0.005_60)] rounded-lg px-3 py-2 text-sm text-[#D4C4A0] focus:outline-none focus:border-[#B09B71]"
                  />
                </div>
              ))}
              <div>
                <label className="block text-xs text-[oklch(0.45_0.01_60)] mb-1">Carrier</label>
                <select value={form.carrier} onChange={e => setForm({ ...form, carrier: e.target.value as Carrier })} className="w-full bg-[oklch(0.16_0.005_60)] border border-[oklch(0.24_0.005_60)] rounded-lg px-3 py-2 text-sm text-[#D4C4A0] focus:outline-none focus:border-[#B09B71]">
              ...
              <div>
                ...
                <select value={form.status} onChange={e => setForm({ ...form, status: e.target.value as PackageStatus })} className="w-full bg-[oklch(0.16_0.005_60)] border border-[oklch(0.24_0.005_60)] rounded-lg px-3 py-2 text-sm text-[#D4C4A0] focus:outline-none focus:border-[#B09B71]">
