...
const CONTACTS: Contact[] = [
  // HOA Board
  { id: 'board-president', category: 'HOA Board', name: 'Board President', phone: '(555) 201-0001', note: 'Contact for HOA matters and urgent property issues', icon: '', urgent: false },
